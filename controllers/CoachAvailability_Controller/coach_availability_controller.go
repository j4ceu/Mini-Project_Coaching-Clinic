...
type coachAvailabilityController struct {
	coachAvailabilityService CoachAvailability_Service.CoachAvailabilityService
}

func NewCoachAvailabilityController(coachAvailabilityService CoachAvailability_Service.CoachAvailabilityService) *coachAvailabilityController {
