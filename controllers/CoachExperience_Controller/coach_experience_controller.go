...
type coachExperienceController struct {
	coachExperienceService CoachExperience_Service.CoachExperienceService
}

func NewCoachExperienceController(coachExperienceService CoachExperience_Service.CoachExperienceService) *coachExperienceController {
