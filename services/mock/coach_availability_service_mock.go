...
func (m *MockCoachAvailabilityService) FindByID(id string) (models.CoachAvailability, error) {
	args := m.Called(id)
	return args.Get(0).(models.CoachAvailability), args.Error(1)
}

func (m *MockCoachAvailabilityService) Create(coachAvailability models.CoachAvailability) (models.CoachAvailability, error) {
	args := m.Called(coachAvailability)
	return args.Get(0).(models.CoachAvailability), args.Error(1)
}

func (m *MockCoachAvailabilityService) Update(coachAvailability models.CoachAvailability, id string) (models.CoachAvailability, error) {
